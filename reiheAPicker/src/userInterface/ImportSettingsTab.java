...
public class ImportSettingsTab {
	...
	private void configureElements()
	{
		...
		this.gridpane.add(this.settingsLabel5, 0, 4);	this.gridpane.add(this.settingsTextField5_checkbox, 1, 4); 
		this.gridpane.add(this.settingsLabel6, 0, 5);	this.gridpane.add(this.settingsTextField6_checkbox, 1, 5);
		this.gridpane.add(this.catalogueSearch, 0, 6); this.gridpane.add(new Text("Variablen: [{[author]}], [{[title]}], [{[isbn]}], [{[publisher]}]"), 1, 6);
		this.gridpane.add(this.settingsLabel8, 0, 7);	this.gridpane.add(this.settingsTextField8, 1, 7);	this.gridpane.add(this.searchFieldLabel1, 2, 7);
		this.gridpane.add(this.settingsLabel9, 0, 8);	this.gridpane.add(this.settingsTextField9, 1, 8);	this.gridpane.add(this.searchFieldLabel2, 2, 8);
		this.gridpane.add(this.settingsLabel10, 0, 9);	this.gridpane.add(this.settingsTextField10, 1, 9);	this.gridpane.add(this.searchFieldLabel3, 2, 9);
		this.gridpane.add(this.settingsLabel11, 0, 10);	this.gridpane.add(this.settingsTextField11, 1, 10);	this.gridpane.add(this.searchFieldLabel4, 2, 10);
		this.gridpane.add(this.settingsLabel12, 0, 11);	this.gridpane.add(this.settingsTextField12, 1, 11);	this.gridpane.add(this.searchFieldLabel5, 2, 11);
		this.gridpane.add(this.settingsLabel13, 0, 12);	this.gridpane.add(this.settingsTextField13, 1, 12);	this.gridpane.add(this.searchFieldLabel6, 2, 12);
		this.gridpane.add(this.settingsLabel14, 0, 13);	this.gridpane.add(this.settingsTextField14, 1, 13);	this.gridpane.add(this.searchFieldLabel7, 2, 13);
		this.gridpane.add(this.settingsLabel15, 0, 14);	this.gridpane.add(this.settingsTextField15, 1, 14);	this.gridpane.add(this.searchFieldLabel8, 2, 14);
		this.gridpane.add(this.settingsLabel16, 0, 15);	this.gridpane.add(this.settingsTextField16, 1, 15);	this.gridpane.add(this.searchFieldLabel9, 2, 15);
		this.gridpane.add(this.settingsLabel17, 0, 16);	this.gridpane.add(this.settingsTextField17, 1, 16);	this.gridpane.add(this.searchFieldLabel10, 2, 16);
		this.gridpane.add(this.settingsLabel18, 0, 17);	this.gridpane.add(this.settingsTextField18, 1, 17);	this.gridpane.add(this.searchFieldLabel11, 2, 17);
		this.gridpane.add(this.settingsLabel19, 0, 18);	this.gridpane.add(this.settingsTextField19, 1, 18);	this.gridpane.add(this.searchFieldLabel12, 2, 18);	
		this.gridpane.add(this.markierungseinstellungen , 0, 19);
		this.gridpane.add(this.settingsLabel20, 0, 20);	this.gridpane.add(this.settingsTextField20, 1, 20);	this.gridpane.add(new Text("z.b. 'Pädagogik;Sozialwissenschaft;Herder;DDC-Sachgruppe:S;Verlagsort:Freiburg'"), 2, 20);
		this.gridpane.add(this.settingsLabel21, 0, 21);	this.gridpane.add(this.settingsTextField21, 1, 21);	this.gridpane.add(new Text("z.b. 'Scientology;Grin-Verlag;DDC-Sachgruppe:B;Autor:Guttenberg;Auflage:Unver'"), 2, 21);	
		this.gridpane.add(this.apisettings , 0, 22);
		this.gridpane.add(this.settingsLabel22, 0, 23);	this.gridpane.add(this.settingsTextField22, 1, 23);	this.gridpane.add(new HBox(this.settingsLabel22b, new Label(" "), this.settingsTextField22b,new Label(" "), this.settingsLabel22c,new Label(" "), this.settingsTextField22c),  2, 23);
		this.gridpane.add(this.settingsLabel23, 0, 24);	this.gridpane.add(this.settingsTextField23_checkbox, 1, 24);	this.gridpane.add(new Text("Sämtliche Datensätze werden beim Laden geprüft."), 2, 24);	
		this.gridpane.add(this.settingsLabel24, 0, 25);	this.gridpane.add(this.settingsTextField24_checkbox, 1, 25);	this.gridpane.add(new Text("Erfordert Option 'Bestand nach Import prüfen'"), 2, 25);
		this.gridpane.add(this.settingsLabel25, 0, 26);	this.gridpane.add(this.settingsTextField25_checkbox, 1, 26);	
		this.gridpane.add(this.settingsLabel26, 0, 27);	this.gridpane.add(this.settingsTextField26_checkbox, 1, 27);	this.gridpane.add(new Text("Erfordert Option 'Bestand nach Import prüfen'"), 2, 27);
